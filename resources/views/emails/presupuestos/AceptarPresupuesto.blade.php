          ...
          <table width="100%" align="left" border="0" cellpadding="0" cellspacing="0">  
            <tr>
              <td height="70" style="padding: 0 20px 20px 0;">
                <img class="fix" src="http://rotuleon.rotuleon.net:8081/img/RotuleonNL.png" width="100%" height="70" border="0" alt="Grupo Rotuleon" />
              </td>
            </tr>
          </table>
          <!--[if (gte mso 9)|(IE)]>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td  class="h1" style="padding: 5px 0 0 0;">
                      <p class="h3">PRESUPUESTO ACEPTADO <h2>
                    </td>
                  </tr>
                </table>
              </td>
                    ...
                    <td style="padding: 20px 0 0 0;">
                      <table class="buttonwrapper" bgcolor="#eb6020" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <a target="_blank" href='{{ $datos->email }}'>NUEVO TRABAJO</a>
 ...
 -->                          
      ...
      <tr>
        <td class="innerpadding bodycopy">
          ...
          P.I. de León, Fase I, Parcela G30 <br>
          24231 Onzonilla <br>
