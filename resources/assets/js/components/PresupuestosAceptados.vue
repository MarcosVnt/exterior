          ...
          <div class="card-body">
            ...
            <div class="table-responsive">
              <table class="table table-bordered table-striped table-sm">
                ...
                <tbody v-if="arrayPresupuesto.length === 0">
                  <tr>
                    <p style="color:red"> No hay registros que cumplan las condiciones </p>
                    </tr>
                </tbody>
                <tbody v-else>
                  <tr
                  ...
                  >
                    ...
                    <td v-text="presupuesto.name"></td>
                                        <td v-text="presupuesto.id"></td>

                    <td type="date" >{{presupuesto.fecha_presupuesto | fechaF}}</td>
                   ...
                   <!--  <td v-text="presupuesto.fecha_entrega"></td> -->
                     <td >{{presupuesto.fecha_entrega | fechaF}}</td>
              ...
              <li class="nav-item">
               ...
               <li class="nav-item" >
                <a
                  ...
                  href="#fabricacion"
                  >Datos Fabricación
                     <i class="fa fa-clone"  v-if="presupuestoDocumentosLista.length>0"
></i>
                     <span  v-if="presupuestoDocumentosLista.length>0"
class="badge badge-pill badge-danger">{{presupuestoDocumentosLista.length}}</span>

   <i class="icon-camera"  v-if="presupuestoImagenesLista.length>0 "
></i>
  <span  v-if="presupuestoImagenesLista.length>0 "
class="badge badge-pill badge-danger">{{presupuestoImagenesLista.length}}</span>
                  </a
                ...
                <div class="form-group row border">
                   <div class="col-md-6">
                    <div class="form-group">
                     ...
                     <fotos-subir v-if="cargado"
                     :presupuestoImagenesLista ="this.presupuestoImagenesLista"

                     :presupuestoDocumentosLista ="this.presupuestoDocumentosLista"
                        ...
                        <!-- 1501 precio compra unidad , -->
                         <!--  <td class="text-right">{{ componente.precio * componente.cantidad }}<br>
                          {{ componente.precio}}x{{ componente.cantidad }}
                           ...
                           <td class="text-right">{{ componente.precio  }} €
                   ...
                   -->   
                        ...
                        <th>
                          <div class="btn-group btn-budget-group pull-right">
                             ...
                             <button v-if=(muestraTotalPresupuesto)
                              type="button"
...
<!--              FOOTER PRESUPUESTO -->              
    ...
    <ArticuloComponente v-if="modalarticulo" 
     :Modelo = "modelo"
     :Datos = "data"
     :Accion = "accion"
...
console.log('2801 finalizargfotossubir ',que,this.presupuestoImagenesLista2);
...
let me = this;
           console.log(
            "2801 2 - RECARGAR IMAGE 1 tamaño de array imagenes lista :",img,
            me.presupuestoImagenesLista.length,me.presupuestoImagenesLista,me.presupuestoImagenesLista2
...
//    obj.src = './storage/'+me.presupuestoImagenesLista[i].nombre;
  ...
  obj.caption = me.presupuestoImagenesLista[i].slug;
    ...
    console.log(
            ...
            me.images,'--->',me.presupuestoImagenesLista[i],'me.images', me.presupuestoImagenesLista,
            "creo OBJETO  oj "
          );
...
this.load = false;
    ...
    abrirCarousel(){
         console.log('2801 abrirCarousel  inicio MAS RECARGAR IMAGE', this.presupuestoImagenesLista)
    ...
    calcularTotalPresupuesto2: function () {
      ...
      console.log("CALCULARPRESUPUSTO 222 Costes", costes, this.cabecera.costes);
    ...
    desactivarArticulo(articulo,idx){
      ...
      // si en db esta marcado no tener encuenta para calculo.
       swal({
        title: "Esta seguro de Desactivar este Articulo .No Imprime , No calcula total ?",
        type: "warning",
        showCancelButton: true,
        confirmButtonColor: "#3085d6",
        cancelButtonColor: "#d33",
        ...
        if (result.value) {
          axios
            ...
            .then(function (response) {
              ...
              if(response){
                  console.log('eee',me.articulos,idx,response, response.data,response.data.a);
...
console.log('duplicar',response,response.data.id);
    ...
    recalcularBeneficioArticulo: function () {
      ...
      this.articulobeneficio = +(([(this.articuloimportefinal - base) / base] * 100).toFixed(3));
    ...
    recalcularBeneficioEditar: function () {
      ...
      me.cabeceraEdita.beneficios = +(([(importe - base) / base] * 100).toFixed(3));
    ...
    listarPresupuesto(page, buscar, criterio) {
      ...
      axios
        ...
        .then(function (response) {
          ...
          console.log('LISTAR PRESUPUESTO',me.arrayPresupuesto,me.arrayPresupuesto.length,respuesta.presupuestos.data.length);
...
cabecera.contacto_envio */
 ...
 console.log(
      "FOTOSSUBIR -> GET",me.presupuestoImagenesLista,me.presupuestoDocumentosLista);
    ...
    presupuestoPdf(id) {
      ...
      window.open("/presupuesto/pdf?id=" + id +"&T="+this.muestraTotalPresupuesto,"_blank");
 ...
 */          
          console.log(
            ...
            me.articulos,
            me.componentes,
            me.dropzoneOptionsImagen,me.dropzoneOptionsFichero,
          );
        ...
        if (result.value) {
          ...
          for (var i = 0; i < this.componentes.length; i++) {
            if (
              ...
              /*  this.componentes[i].articulo_principal == componente.articulo_principal &&
              this.componentes[i].articulo == componente.articulo 
 */
              /* 1501 quitado porque borraba todos menos el seleccionado this.componentes[i].idpresupuestolinea ==
 ...
 */
      ...
      for (var i = 0; i < me.componentes.length; i++) {
        ...
        if (
          ...
          console.log(
            ...
            "1601 recalcularTotalArticulo",
            sw,
            me.componentes[i].importefinal,me.componentes[i].descripcion,
            tpvp
          );
        }
      }
    ...
    recalcularTotalArticuloCambiado(origen, id) {
      ...
      for (var i = 0; i < me.componentes.length; i++) {
        if (me.componentes[i].idpresupuestolinea === me.articulos[objIndex].id ) {
 ...
 */
       ...
       me.articulos[objIndex].precio = +(tcoste/ me.articulos[objIndex].bultos).toFixed(2);
       ...
       me.articulos[objIndex].preciofinal = +(tbase/ me.articulos[objIndex].bultos).toFixed(2);
      ...
      //1108  let bene2 = +([(me.articulos[objIndex].base - me.articulos[objIndex].costes) / me.articulos[objIndex].costes] * 100).toFixed(3);

     /*   let merma2 = +([(me.articulos[objIndex].preciofinal - me.articulos[objIndex].precio) / me.articulos[objIndex].precio] * 100).toFixed(2); */

        let dto2 = +(me.articulos[objIndex].importefinal - me.articulos[objIndex].base);
    ...
    // cambiado a peticion de isaac
      let bene2=0;

      if( me.articulos[objIndex].beneficios > 0  ){
         // no hago nada porque prevalece el beneficio puesto en el articulo , no el recalculo del componente
           bene2 =  me.articulos[objIndex].beneficios; // prevalece el beneficio del articulo ...
           console.log('1108 1', me.articulos[objIndex].beneficios ,'bene2',bene2);
       ...
       let bene2 = +(
        [
          ...
          console.log('1108x2', me.articulos[objIndex].beneficios ,'bene2',bene2);
        
      } 
 
      console.log('1108 3', me.articulos[objIndex].beneficios ,'bene2',bene2);

      //1108  me.articulos[objIndex].beneficios = bene2;
    ...
    //1108 me.articulos[objIndex].beneficios=bene2;
        //me.articulos[objIndex].mermas=merma2;
            ...
            console.log('bbb', me.articulos[objIndex].dto, me.articulos[objIndex].beneficios);
