  ...
  methods: {
    ...
    /*   me.acAnchura = Math.round(me.acAnchura);
      ...
      if (me.acMermas > 0) {
        ...
        console.log('170322 - mermas>0', precioCoste);
       ...
       // me.acSubtotal1 = +(me.acPrecio * me.acUnidades).toFixed(2);
               console.log('170322 - else>0', precioCoste);

      }
        //coste      
        me.acSubtotal1 = +(precioCoste * me.acUnidades).toFixed(2);
        console.log('170322 - subtotal1>0', me.acSubtotal1);
     ...
     me.acPrecioVentaUnidad = me.acPrecioFinal; 
     //170322 cambiado para que no reaclcule ...  +(me.acSubtotal3 / me.acBultos).toFixed(3);
 ...
 let bene2 = +([(me.articulos[objIndex].base - me.articulos[objIndex].costes) / me.articulos[objIndex].costes] * 100).toFixed(3); */
     ...
     //170322 cambiado para que no reaclcule ... +(me.acSubtotal3 / me.acBultos).toFixed(3);
      ...
      me.acPvp = me.acSubtotal4;
            ...
            console.log('recalcularBeneficio 1000 170322 -> ','beneficio',me.acBeneficios , 'costes', me.acCostes, 'base', me.acBase, 'pvp', me.acPvp);
            // me.acDto, me.acBeneficios, me.acBase, me.acSubtotal4);
