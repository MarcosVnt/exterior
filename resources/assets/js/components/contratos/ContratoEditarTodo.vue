    ...
    <div id="pro-wizard">
        ...
        <div v-if="currentstep == 2">
            ...
            <div class="card-body">
                 ...
                 <div class="form-group row">
                    <label for="observaciones">Observaciones</label>
                    <textarea class="form-control" id="observaciones" rows="3" v-model="agencia.observaciones"
                    :readonly="agencia.id >= 1"></textarea>
                </div>
        ...
        <div v-if="currentstep == 4">
            ...
            <div class="form-group row">
              <label class="col-md-1 form-control-label" for="direccion-input">Forma de Pago</label>
                           ...
                           <select class="form-control col-md-3" id="forma_pago" v-model="contrato.forma_pago">
   ...
   mounted() {
     ...
     methods: {
         cargarDatosContrato(v){
             console.log('2102 cargarDatos sdf',v);
                  let me = this;
