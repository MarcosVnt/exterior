      ...
      <div class="card-body">
        <div class="tz-gallery">
          <div class="row mb-3">
            <div
              class="col-md-4"
              v-for="(fotoDia, index) in fotosDelDia"
              :key="fotoDia.obrafotoid"
            ...
            <!--  v-on:remove="fotoDia.splice(fotoDia.id, 1)" -->
              <div class="card" id="`${fotoDia.imagen}`">
                ...
                <img :src="'/storage/'+`${fotoDia.imagen}`" alt="Park" class="card-img-top" />
                ...
                <button
                  type="submit"
                  v-on:click.prevent="borrarFoto(fotoDia.obrafotoid,index)"
