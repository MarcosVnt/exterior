<template>
              ...
              <li role="presentation" class="budget-tab active">
                ...
                <div class="btn-group pull-right" style="padding: 8px">
                  <h3>Presupuesto Nº : {{ cabecera.id }}</h3>
                    <button
                      type="button"
                      @click="duplicarPresupuestoRotuleon(cabecera.id)"
                      class="btn btn-warning btn-sm pull-right"
                      style="margin-left: 50px;"
                    >
                      <i class="fa fa-plus-square" aria-hidden="true"></i>Duplicar Presupuesto
 ...
 -->
              ...
              <div>
                ...
                >
                  <i class="fa fa-save" aria-hidden="true"></i> PDF SIMPLE
                </button>
              </div>
            </div>
          </div>
 ...
 */
  ...
  methods: {
     duplicarPresupuestoRotuleon(id){



       swal({
        title:
          "Esta seguro de DUPLICAR este presupuesto en Exterior ?",
        type: "warning",
        ...
        if (result.value) {
          ...
          console.log('duplicarPresupuestoRotuleon', id);
          let $url = "presupuesto/duplicarrotuleon";
          ...
          axios
            ...
            .then(function (response) {
              /*  me.cerrarModal();
                ...
                let presu = response.data.presupuesto;
              //  let detal = response.data.detalle;
              //  let compo = response.data.componente;


            console.log('insrtado ',presu, presu.id);
              swal(
                "Duplicado!",
                "El proceso Duplicado el presupuesto correctamente.",
                "success"
              ); 
            })
 ...
 me.images[0]=obj2 */ /* [{
  ...
  var fechaAceptado = new Date();
      ...
      swal({
        title: "Confirme Presupuesto Aceptado Fecha de Entrega:  "+fechaAceptado.toLocaleDateString().slice(0,10),
        input: "select",
        inputOptions: {
                    "ACEPTADO": "ACEPTADO",
        ...
        if (result.value) {
          ...
          me.cabecera.estado = resultado;
           if(resultado = 'ACEPTADO'){
            ...
            me.cabecera.fecha_entrega = fechaAceptado.toISOString().slice(0,10);       

           //  console.log("validar Email fecha ",fechaAceptado,fechaAceptado.toISOString().slice(0,10));
          }
    ...
    tarifaProductoCrear(articulo) {
      swal({
        ...
        text: "Introduzca Nombre del Producto tarifa",
        input: "text",
        type: "warning",
        showCancelButton: true,
        confirmButtonColor: "#3085d6",
        ...
        if (result.value) {
          ...
          console.log("tarifaProductoCrear", articulo, "result", result);
          let componentes = this.filteredRows1(articulo);
...
cabecera.contacto_envio */
    ...
    guardarPresupuesto(listar) {
      ...
      console.log(
        "09042021 yye 333 guardarPresupuesto ACTUALIZAR PRESUPUESTO",
        this.cabecera
      );
      ...
      if (actualizar === true) {
        console.log("09042021 aaa guardarPresupuesto ACTUALIZAR ----");
        ...
        axios
          ...
          .then(function (response) {
            /*  me.cerrarModal();
                    me.listarCategoria(1,'','nombre'); */
            console.log(
              "09042021 aaa GUARDA PRESUPUESTO guardarPresupuesto",
              me.presupuestoId,
              response,
              response.data.id
            );
        ...
        console.log(" 09042021 aaa zzz guardarPresupuesto REGISTRAR", this.cabecera);
 ...
 let me = this;
      me.guardarPresupuesto();
       console.log('09042021 setimeout window.open1111',me.muestraTotalPresupuesto);

      setTimeout(function() {
        console.log('09042021 setimeout window.open2222',me.muestraTotalPresupuesto);
       window.open(
          "/presupuesto/pdf?id=" + id + "&T=" + me.muestraTotalPresupuesto,
          "_blank"
        );

      },2000);
       console.log('09042021 setimeout window.open333333333333331111');


      /* if (this.guardarPresupuesto()) {
        window.open(
    ...
    presupuestoPdfFabricacion(id) {
      ...
      let me = this;
      me.guardarPresupuesto();
       console.log('09042021 setimeout window.open1111');

      setTimeout(function() {
        console.log('09042021 setimeout window.open2222');
       window.open(
          "/presupuesto/pdf-fabricacion?id=" + id + "&T=" + me.muestraTotalPresupuesto,
          "_blank"
        );
 ...
 */
 this.componentes[i].id ===
    ...
    recalcularTotalArticulocambiado(origen, id) {
      ...
      //290421 hablado con Isaac quiatado me.articulos[objIndex].mermas = +(tmermas / a).toFixed(2);
      me.articulos[objIndex].mermas = 0;
      ...
      console.log("bbb 1108", a, tbene / a, tdto / a, me.articulos[objIndex]);
      //BUSCO ARTICULO Y ACTUALIZSO COSTE
      axios
        .put("/presupuesto/detalle/actualizar/coste", {
          id: me.articulos[objIndex].id,
