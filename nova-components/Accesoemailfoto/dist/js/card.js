...
Nova.booting(function (Vue, router, store) {
    Vue.component('accesoemailfoto', __webpack_require__(2));
});
...
var update = __webpack_require__(6)("b986a0bc", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../nova-components/accesoemailfoto/node_modules/css-loader/index.js!../../../nova-components/accesoemailfoto/node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-b9bc2c0a\",\"scoped\":false,\"hasInlineConfig\":true}!./vue-multiselect.min.css", function() {
     var newContent = require("!!../../../nova-components/accesoemailfoto/node_modules/css-loader/index.js!../../../nova-components/accesoemailfoto/node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-b9bc2c0a\",\"scoped\":false,\"hasInlineConfig\":true}!./vue-multiselect.min.css");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    selectObra: function selectObra(_ref) {
    ...
    sendEmail: function sendEmail() {
      ...
      .post("/send-mail", {
        ...
        if (response.status == 200) {
          _this.mensajes.push("CORRECTO : Email enviado a : ", _this.email, "para tramitar fotos de :", _this.obra.codigo, "/", _this.obra.nombre);
          //alert("Email ha sido enviado a :  " + this.email + this.obra);
        } else {
          _this.mensajes.push("ERROR : en el envio de Email", response);
  ...
  return _c(
    ...
    [
      _c("multiselect", {
        ...
        attrs: {
          options: _vm.obrasUsuario,
          "max-height": 600,
          "custom-label": _vm.selectObra,
      ...
      _c("div", { staticClass: "p-4" }, [
        _c("p", { staticClass: "mb-2 dim text-80 font-bold" }, [
          _vm._v("Introduzca email de colaborador para envío.")
        ]),
        _vm._v(" "),
        _c("input", {
          directives: [
      ...
      _vm._v(" "),
      _vm.mensaje ? _c("div", { staticClass: "p-4" }) : _vm._e(),
      _vm._v(" "),
      _c("hr"),
      _vm._v(" "),
      _c(
        "div",
        {
          ...
          staticClass: "col-md-12 div-error"
        },
        [
          _c(
            "div",
            { staticClass: "text-center text-error" },
            _vm._l(_vm.mensajes, function(error) {
              return _c("div", {
                key: error,
