...
Nova.booting(function (Vue, router, store) {
    Vue.component('fotosultimas-card', __webpack_require__(7));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    rotarFotoObra: function rotarFotoObra(id, codigo, url) {
    ...
    irObra: function irObra(obra) {
      console.log("ira a obra pdf", obra, window.location.hostname);
      window.open("http://" + window.location.hostname + ":8081/nova/resources/obras/" + obra);
    },
    ...
    listarFotosDeUnaObra: function listarFotosDeUnaObra(pag, buscar, criterio) {
      ...
      var url = "/ultimasfotos?page=" + pag + "&buscar=" + buscar + "&criterio=" + criterio;

      axios.get(url).then(function (response) {
        //000  me.hayFotos = 0;

        var respuesta = response.data;
        console.log("INICIO----DOS --------listarfotos", response, "response.data", response.data, "response.data2", response.data.ultimasFotos2.data);
        ...
        console.log("unoooooooooo", me.images2, Array.isArray(me.images2), _typeof(me.images2 === "function")), _typeof(me.images2 === "object");
        ...
        console.log("unoooooooooo", arrayColumn(me.images2, "imagen"), me.imagesImagen);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../nova-components/FotosultimasCard/node_modules/css-loader/index.js!./blueimp-gallery.min.css", function() {
			var newContent = require("!!../../../nova-components/FotosultimasCard/node_modules/css-loader/index.js!./blueimp-gallery.min.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
      ...
      _c(
        ...
        [
          _c("div", { staticClass: "flex flex-wrap w-full" }, [
            _c("div", { staticClass: "px-3 py-3 mt-4" }, [
              _c(
                "h1",
                { staticClass: "text-center text-3xl text-80 font-light" },
                [_vm._v("\n          Fotos ultimos trabajos ::: ")]
              )
            ])
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "flex flex-wrap w-full" }, [
            _c("div", { staticClass: "bg-20 rounded-b" }, [
              _c(
                ...
                {
                  staticClass:
                    "flex justify-between items-center text-90 font-normal text-2xl"
                },
                [
                  _c(
                    "button",
                    {
                      staticClass: "btn btn-link py-3 px-4 text-80 dim",
                  ...
                  _vm._v(" "),
                  _c("span", { staticClass: "text-90 font-normal text-2xl" }, [
                    _vm._v(
                      "\n            " +
          ...
          _c(
            ...
            [
              _c("gallery", {
                attrs: { images: _vm.imagesImagen, index: _vm.index },
                on: {
              ...
              _vm._v(" "),
              _vm._l(_vm.images2, function(image, imageIndex) {
                return _c(
                  "div",
                  {
                    key: imageIndex,
                  ...
                  [
                    _c(
                      ...
                      [
                        _c("img", {
                          ...
                          attrs: { src: "" + image.imagen, alt: "Park" }
                        })
                      ]
                    ),
                    _vm._v(" "),
                    _c("div", { staticClass: "row" }, [
                      ...
                      _c(
                        ...
                        {
                          staticClass:
                            "span6 btn btn-link py-3 px-4 text-80 dim",
                          attrs: { rel: "prev", dusk: "previous" },
                          on: {
                            click: function($event) {
                              $event.preventDefault()
                              return _vm.irObra(image.id)
                            }
                          }
                        },
                        [
